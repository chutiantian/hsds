...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $ttBox = $("<div>").addClass("ttBox").addClass("bg").addClass("h40");//弹窗顶部区域
		
		var $txtBox = $("<div>").addClass("txtBox");//弹窗内容主体区
		var $btnArea = $("<div>").addClass("btnArea");//按钮区域
		
		var $ok = $("<a>").addClass("sgBtn").addClass("ok").text("保存并使用");//确定按钮
		//var $cancel = $("<a>").addClass("sgBtn").addClass("cancel").text("取消");//取消按钮
		var $input = $("<input>").addClass("inputBox");//输入框
		var $clsBtn = $("<a>").addClass("clsBtn").addClass("iconfont icon-close");//关闭按钮
	...
	//公开关闭方法
	window.wxc.xcConfirm.close = doClose;		
	};
